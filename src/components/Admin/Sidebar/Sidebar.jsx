    ...
    <div className='sticky top-0 left-0 z-40'>
      ...
      >
        <header className='p-4 flex border-b border-b-gray-200 items-center justify-between'>
          ...
          <button onClick={() => setIsMobileOpen(false)} className='flex md:hidden p-1 rounded-md bg-gray-100 cursor-pointer'>
            { expanded && <DynamicIcon name='square-x' /> }
          </button>
        </header>
        ...
        <ul className='p-4 h-full'>
          <li className='flex items-center p-3 cursor-pointer transition-all hover:bg-gray-100 rounded-md focus:bg-gray-500 active:bg-gray-200 group'>
            <a href="" className='flex items-center'>
              ...
              <h2 className={`${expanded ? 'px-4 font-medium text-lg origin-left transition-all': 'px-2 rounded-sm font- text-sm origin-left invisible group-hover:bg-sky-500/10 group-hover:rounded-sm group-hover:visible group-hover:translate-x-14 transition-all'}`}>Dashboard</h2>  
            </a>
          </li>
